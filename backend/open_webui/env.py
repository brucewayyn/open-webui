...
ENABLE_API_OUTLET_FILTERS = os.environ.get('ENABLE_API_OUTLET_FILTERS', 'True').lower() == 'true'
...
CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS = os.environ.get(
    'CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS',
    os.environ.get('CHAT_RESPONSE_MAX_TOOL_CALL_RETRIES', '256'),
)
